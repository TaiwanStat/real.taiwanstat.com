...
temp_url = 'http://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_1p00.pl?file=' + gfs + '&lev_70_mb=on&var_TMP=on&leftlon=0&rightlon=360&toplat=90&bottomlat=-90&dir=%2Fgfs.' + date
path = './data/weather/current/current-temp-isobaric-70hPa-gfs-1.0.json'
update_data(temp_url, path)

wind_url = 'http://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_1p00.pl?file=' + gfs + '&lev_70_mb=on&var_UGRD=on&var_VGRD=on&leftlon=0&rightlon=360&toplat=90&bottomlat=-90&dir=%2Fgfs.' + date
path = './data/weather/current/current-wind-isobaric-70hPa-gfs-1.0.json'
update_data(wind_url, path)

rh_url = 'http://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_1p00.pl?file=' + gfs + '&lev_70_mb=on&var_RH=on&leftlon=0&rightlon=360&toplat=90&bottomlat=-90&dir=%2Fgfs.' + date
path = './data/weather/current/current-relative_humidity-isobaric-70hPa-gfs-1.0.json'
...
path = './data/weather/current/current-total_precipitable_water-70hPa-gfs-1.0.json'
